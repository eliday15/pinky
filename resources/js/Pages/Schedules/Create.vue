...
const toggleDay = (day) => {
    ...
    if (idx > -1) {
        ...
        // Remove day_schedule override when day is unselected
...
/** Initialize a day override with the default values. */
...
/** When toggling to per-day mode, init overrides for all selected days. */
        ...
        <div class="max-w-4xl">
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <p v-if="form.errors.working_days" class="mt-2 text-sm text-red-600">
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div v-if="sameForAllDays">
                            ...
                            <input
                                ...
                                min="0"
                                class="w-full rounded-lg border-gray-300 shadow-sm focus:border-pink-500 focus:ring-pink-500"
                                :class="{ 'border-red-500': form.errors.break_minutes }"
                            />
                            <p v-if="form.errors.break_minutes" class="mt-1 text-sm text-red-600">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                min="0"
                                class="w-full rounded-lg border-gray-300 shadow-sm focus:border-pink-500 focus:ring-pink-500"
                                :class="{ 'border-red-500': form.errors.late_tolerance_minutes }"
                            />
                            <p v-if="form.errors.late_tolerance_minutes" class="mt-1 text-sm text-red-600">
                                {{ form.errors.late_tolerance_minutes }}
                            </p>
                            <p class="mt-1 text-sm text-gray-500">
                                Minutos permitidos despues de la hora de entrada
                            </p>
                        </div>
                        ...
                        <div v-if="sameForAllDays">
                            ...
                            <input
                                ...
                                step="0.5"
                                class="w-full rounded-lg border-gray-300 shadow-sm focus:border-pink-500 focus:ring-pink-500"
                                :class="{ 'border-red-500': form.errors.daily_work_hours }"
                            />
                            <p v-if="form.errors.daily_work_hours" class="mt-1 text-sm text-red-600">
                                {{ form.errors.daily_work_hours }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="mt-6">
                        ...
                        <p class="mt-1 text-sm text-gray-500 ml-6">
                            Permite a los empleados registrar entrada y salida en horarios variables
                        </p>
                    </div>
                    ...
                    <div class="mt-4">
                        ...
                        <p class="mt-1 text-sm text-gray-500 ml-6">
                            Si esta desactivado, no se podra asignar a nuevos empleados
                        </p>
                    </div>
                </div>
