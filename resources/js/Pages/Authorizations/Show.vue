...
<template>
    ...
    <AppLayout>
        ...
        <div class="max-w-4xl">
            ...
            <div class="space-y-6">
                <!-- Excedente de un split de TE: la checada no respalda estas horas.
                     Aprobarlas = decisión consciente de pagar extra no hecho en el reloj. -->
                <div
                    v-if="authorization.is_unbacked_extra"
                    class="bg-orange-50 border border-orange-200 rounded-lg p-4 flex items-start"
                >
                    ...
                    <div class="text-sm text-orange-800">
                        <p class="font-semibold">Extra fuera de checada</p>
                        <p class="mt-1">
                            Estas horas exceden lo que el reloj checador registró ese día
                    ...
                    <form @submit.prevent="submitApprove">
                        <div class="mb-4">
                            ...
                            <input
                                ...
                                type="number"
                                step="0.01"
                                :min="authorization.compensation_type?.application_mode === 'one_time' ? undefined : 0"
                                placeholder="Sin cambio"
                                class="w-full rounded-lg border-gray-300 shadow-sm focus:border-pink-500 focus:ring-pink-500"
                                :class="{ 'border-red-500': approveForm.errors.hours }"
                            />
                            <p v-if="authorization.compensation_type?.application_mode === 'one_time'" class="mt-1 text-xs text-gray-400">
                                Negativo = descuento.
                            </p>
