...
const toggleSubordinate = (id) => {
    const idx = form.subordinate_ids.indexOf(id);
    if (idx === -1) {
        form.subordinate_ids.push(id);
    } else {
        form.subordinate_ids.splice(idx, 1);
    }
};
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <div v-if="canEditAll" class="mt-6 border-t border-gray-200 pt-6">
                        ...
                        <p class="text-xs text-gray-500 mb-4">PIN personal que el empleado usa para cobrar su efectivo. Dejalo en blanco para no cambiarlo.</p>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                    ...
                    <div v-if="canEditAll" class="mt-6 border-t border-gray-200 pt-6">
                        ...
                        <p class="text-xs text-gray-500 mb-4">NIP personal que el empleado teclea en el kiosco para cobrar su desayuno. Dejalo en blanco para no cambiarlo.</p>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Nuevo NIP de desayunos</label>
                ...
                <div v-if="canEditAll" class="bg-white rounded-lg shadow p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <p v-if="form.errors.daily_salary" class="mt-1 text-sm text-red-600">{{ form.errors.daily_salary }}</p>
                        </div>
                    </div>
        ...
        <div v-if="canCreateUser" class="bg-white rounded-lg shadow p-6 mt-6">
            ...
            <div v-else>
                ...
                <form @submit.prevent="createUserAccount" class="space-y-4">
                    <FormErrorBanner :errors="userForm.errors" />
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <!-- Name -->
                        <div>
            ...
            <div v-if="showZktecoModal" class="fixed inset-0 z-50 flex items-center justify-center">
                ...
                <div class="relative bg-white rounded-lg shadow-xl max-w-md w-full mx-4 p-6">
                    ...
                    <p class="text-sm text-gray-600 mb-6">
                        Si continuas, se le quitara el ID ZKTeco al empleado inactivo y se asignara a este empleado.
                    </p>
