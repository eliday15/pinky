...
<template>
    <Head title="Configuracion - Asistencia" />
        ...
        <div class="max-w-3xl">
            <form @submit.prevent="submit" class="space-y-6">
                <div class="bg-white rounded-lg shadow p-6">
                    <h3 class="text-lg font-semibold text-gray-800 mb-6">Asistencia</h3>
                    ...
                    <div v-if="settings.length === 0" class="text-center py-8 text-gray-500">
                        No hay configuraciones de asistencia disponibles.
                    </div>
                </div>
            ...
            <div class="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div class="flex">
                    ...
                    <div class="text-sm text-blue-700">
                        ...
                        <p class="mt-1">
                            Los cambios en la configuracion de asistencia afectan los calculos futuros.
